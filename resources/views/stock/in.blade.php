    ...
    <div class="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
        <div class="mb-6 flex items-center justify-between gap-3">
            <div>
                ...
                <h1 class="mt-2 font-serif text-4xl text-[#2d241d]">Stok Masuk</h1>
            </div>
        ...
        <form action="{{ route('stock.in.store') }}" method="POST" class="rounded-[2rem] border border-[#eadcc9] bg-white p-6 shadow-sm">
            @csrf
            ...
            <div class="grid gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="note" value="{{ old('note') }}" placeholder="Contoh: Restock supplier" class="w-full rounded-xl border border-[#e1d2c0] bg-[#faf7f4] px-3 py-2.5 focus:border-[#2d241d] focus:outline-none">
            ...
            <div class="mt-6 flex justify-end gap-3">
                ...
                <button type="submit" class="rounded-full bg-[#2d241d] px-5 py-2.5 text-sm font-medium text-[#f8efe8]">Simpan Stok Masuk</button>
            </div>
        </form>
    </div>
</x-app-layout>
